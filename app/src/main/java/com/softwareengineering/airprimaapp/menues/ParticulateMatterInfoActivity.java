...
/**
 * Activity that shows information about particulate matter.
 */
public class ParticulateMatterInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_particulate_matter_info);
    }
